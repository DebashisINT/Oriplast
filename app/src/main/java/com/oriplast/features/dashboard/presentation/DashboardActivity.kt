package com.oriplast.features.dashboard.presentation
...
import com.oriplast.*
import com.oriplast.R
import com.oriplast.app.*
import com.oriplast.app.NewFileUtils.browseDocuments
import com.oriplast.app.NewFileUtils.getExtension
import com.oriplast.app.domain.*
import com.oriplast.app.types.DashboardType
import com.oriplast.app.types.FragType
import com.oriplast.app.types.TopBarConfig
import com.oriplast.app.uiaction.DisplayAlert
import com.oriplast.app.utils.*
import com.oriplast.app.utils.AppUtils.Companion.isProfile
import com.oriplast.base.BaseResponse
import com.oriplast.base.presentation.BaseActivity
import com.oriplast.base.presentation.BaseFragment
import com.oriplast.features.NewQuotation.*
import com.oriplast.features.NewQuotation.api.GetQuotRegProvider
import com.oriplast.features.NewQuotation.model.ViewDetailsQuotResponse
import com.oriplast.features.SearchLocation.SearchLocationFragment
import com.oriplast.features.SearchLocation.locationInfoModel
import com.oriplast.features.TA.ViewAllTAListFragment
import com.oriplast.features.achievement.AchievementFragment
import com.oriplast.features.activities.presentation.*
import com.oriplast.features.addAttendence.*
import com.oriplast.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.oriplast.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.oriplast.features.addAttendence.model.GetReportToFCMResponse
import com.oriplast.features.addAttendence.model.GetReportToResponse
import com.oriplast.features.addAttendence.model.Leave_list_Response
import com.oriplast.features.addorder.presentation.AddOrderFragment
import com.oriplast.features.addshop.model.AddShopRequestData
import com.oriplast.features.addshop.model.AddShopResponse
import com.oriplast.features.addshop.presentation.AddShopFragment
import com.oriplast.features.addshop.presentation.OTPVerificationDialog
import com.oriplast.features.addshop.presentation.ScanImageFragment
import com.oriplast.features.addshop.presentation.ShowCardDetailsDialog
import com.oriplast.features.alarm.model.AlarmData
import com.oriplast.features.alarm.presetation.AttendanceReportFragment
import com.oriplast.features.alarm.presetation.PerformanceReportFragment
import com.oriplast.features.alarm.presetation.VisitReportDetailsFragment
import com.oriplast.features.alarm.presetation.VisitReportFragment
import com.oriplast.features.attendance.AttendanceFragment
import com.oriplast.features.attendance.api.AttendanceRepositoryProvider
...
import com.oriplast.features.averageshop.presentation.AverageShopFragment
import com.oriplast.features.avgorder.presentation.AverageOrderFragment
import com.oriplast.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.oriplast.features.beatCustom.TeamBeatListFragment
import com.oriplast.features.billing.presentation.AddBillingFragment
import com.oriplast.features.billing.presentation.BillingDetailsFragment
import com.oriplast.features.billing.presentation.BillingListFragment
import com.oriplast.features.changepassword.presentation.ChangePasswordDialog
import com.oriplast.features.chat.model.ChatListDataModel
import com.oriplast.features.chat.model.ChatUserDataModel
import com.oriplast.features.chat.model.GroupUserDataModel
import com.oriplast.features.chat.presentation.*
import com.oriplast.features.chatbot.presentation.ChatBotFragment
import com.oriplast.features.chatbot.presentation.ChatBotShopListFragment
import com.oriplast.features.chatbot.presentation.ReportsFragment
import com.oriplast.features.chatbot.presentation.SelectLanguageDialog
import com.oriplast.features.commondialog.presentation.CommonDialog
import com.oriplast.features.commondialog.presentation.CommonDialogClickListener
import com.oriplast.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.oriplast.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.oriplast.features.commondialogsinglebtn.OnDialogClickListener
import com.oriplast.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.oriplast.features.dailyPlan.prsentation.AllShopListFragment
import com.oriplast.features.dailyPlan.prsentation.DailyPlanListFragment
import com.oriplast.features.dailyPlan.prsentation.PlanDetailsFragment
import com.oriplast.features.damageProduct.ShopDamageProductListFrag
import com.oriplast.features.damageProduct.ShopDamageProductSubmitFrag
import com.oriplast.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.oriplast.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.oriplast.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.oriplast.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.oriplast.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.oriplast.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.oriplast.features.dashboard.presentation.model.ContentListResponseModel
import com.oriplast.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.oriplast.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.oriplast.features.device_info.presentation.DeviceInfoListFragment
import com.oriplast.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.oriplast.features.document.DocumentRepoFeatureNewFragment
import com.oriplast.features.document.presentation.DocumentListFragment
import com.oriplast.features.document.presentation.DocumentTypeListFragment
import com.oriplast.features.document.presentation.OpenFileWebViewFragment
import com.oriplast.features.dymanicSection.presentation.AddDynamicFragment
import com.oriplast.features.dymanicSection.presentation.AllDynamicListFragment
import com.oriplast.features.dymanicSection.presentation.DynamicListFragment
import com.oriplast.features.dymanicSection.presentation.EditDynamicFragment
import com.oriplast.features.gpsDisabilityScreen.GpsDisableFragment
import com.oriplast.features.home.presentation.HomeFragment
import com.oriplast.features.homelocation.presentation.HomeLocationFragment
import com.oriplast.features.homelocation.presentation.HomeLocationMapFragment
import com.oriplast.features.know_your_state.KnowYourStateFragment
import com.oriplast.features.lead.LeadFrag
import com.oriplast.features.lead.ViewLeadFrag
import com.oriplast.features.leaveapplynew.LeaveHome
import com.oriplast.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.oriplast.features.localshops.LocalShopListFragment
import com.oriplast.features.localshops.LocalShopListMapFragment
import com.oriplast.features.localshops.NearByShopsMapFragment
import com.oriplast.features.location.*
import com.oriplast.features.location.api.LocationRepoProvider
import com.oriplast.features.location.model.*
import com.oriplast.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.oriplast.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.oriplast.features.login.ShopFeedbackEntity
import com.oriplast.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.oriplast.features.login.presentation.LoginActivity
import com.oriplast.features.logout.presentation.api.LogoutRepositoryProvider
import com.oriplast.features.logoutsync.presentation.LogoutSyncFragment
import com.oriplast.features.marketing.presentation.MarketingPagerFragment
import com.oriplast.features.meetinglist.prsentation.MeetingListFragment
import com.oriplast.features.member.MapViewForTeamFrag
import com.oriplast.features.member.model.TeamLocDataModel
import com.oriplast.features.member.model.TeamShopListDataModel
import com.oriplast.features.member.presentation.*
import com.oriplast.features.menuBeat.MenuBeatFrag
import com.oriplast.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.oriplast.features.micro_learning.presentation.MicroLearningListFragment
import com.oriplast.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.oriplast.features.myallowancerequest.MyallowanceRequestFragment
import com.oriplast.features.myjobs.model.CustomerDataModel
import com.oriplast.features.myjobs.presentation.*
import com.oriplast.features.myorder.presentation.MyOrderListFragment
import com.oriplast.features.myprofile.presentation.MyProfileFragment
import com.oriplast.features.nearbyshops.api.ShopListRepositoryProvider
import com.oriplast.features.nearbyshops.model.ShopData
import com.oriplast.features.nearbyshops.model.ShopListResponse
import com.oriplast.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.oriplast.features.nearbyshops.presentation.BeatListFragment
import com.oriplast.features.nearbyshops.presentation.NearByShopsListFragment
import com.oriplast.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.oriplast.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.oriplast.features.newcollection.CollectionDetailsStatusFragment
import com.oriplast.features.newcollection.CollectionShopListFragment
import com.oriplast.features.newcollection.NewCollectionListFragment
import com.oriplast.features.newcollectionreport.*
import com.oriplast.features.notification.NotificationFragment
import com.oriplast.features.orderList.NewDateWiseOrderListFragment
import com.oriplast.features.orderList.NewOrderListFragment
import com.oriplast.features.orderList.OrderListFragment
import com.oriplast.features.orderdetail.presentation.OrderDetailFragment
import com.oriplast.features.orderhistory.ActivityMapFragment
import com.oriplast.features.orderhistory.OrderhistoryFragment
import com.oriplast.features.orderhistory.TimeLineFragment
import com.oriplast.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.oriplast.features.orderhistory.model.FetchLocationRequest
import com.oriplast.features.orderhistory.model.FetchLocationResponse
import com.oriplast.features.orderhistory.model.LocationData
import com.oriplast.features.pendinglocationinout.PendingOutLocationFrag
import com.oriplast.features.performance.GpsStatusFragment
import com.oriplast.features.performance.PerformanceFragment
import com.oriplast.features.performance.api.UpdateGpsStatusRepoProvider
import com.oriplast.features.performance.model.UpdateGpsInputParamsModel
import com.oriplast.features.performanceAPP.PerformanceAppFragment
import com.oriplast.features.permissionList.ViewPermissionFragment
import com.oriplast.features.photoReg.*
import com.oriplast.features.privacypolicy.PrivacypolicyWebviewFrag
import com.oriplast.features.quotation.presentation.*
import com.oriplast.features.reimbursement.presentation.*
import com.oriplast.features.report.presentation.*
import com.oriplast.features.returnsOrder.*
import com.oriplast.features.settings.presentation.SettingsFragment
import com.oriplast.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.oriplast.features.shopdetail.presentation.*
import com.oriplast.features.shopdetail.presentation.api.EditShopRepoProvider
import com.oriplast.features.stock.StockDetailsFragment
import com.oriplast.features.stock.StockListFragment
import com.oriplast.features.stockAddCurrentStock.AddShopStockFragment
import com.oriplast.features.stockAddCurrentStock.UpdateShopStockFragment
import com.oriplast.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.oriplast.features.stockCompetetorStock.AddCompetetorStockFragment
import com.oriplast.features.stockCompetetorStock.CompetetorStockFragment
import com.oriplast.features.stockCompetetorStock.ViewComStockProductDetails
import com.oriplast.features.survey.SurveyFrag
import com.oriplast.features.survey.SurveyViewDtlsFrag
import com.oriplast.features.survey.SurveyViewFrag
import com.oriplast.features.task.presentation.AddTaskFragment
import com.oriplast.features.task.presentation.CalenderTaskFragment
import com.oriplast.features.task.presentation.EditTaskFragment
import com.oriplast.features.task.presentation.TaskListFragment
import com.oriplast.features.timesheet.presentation.AddTimeSheetFragment
import com.oriplast.features.timesheet.presentation.EditTimeSheetFragment
import com.oriplast.features.timesheet.presentation.TimeSheetListFragment
import com.oriplast.features.viewAllOrder.CartFragment
import com.oriplast.features.viewAllOrder.OrderTypeListFragment
import com.oriplast.features.viewAllOrder.ViewAllOrderListFragment
import com.oriplast.features.viewAllOrder.ViewCartFragment
import com.oriplast.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.oriplast.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.oriplast.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.oriplast.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.oriplast.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.oriplast.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.oriplast.features.viewPPDDStock.ViewOutstandingFragment
import com.oriplast.features.viewPPDDStock.ViewPPDDListFragment
import com.oriplast.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.oriplast.features.viewPPDDStock.ViewStockFragment
import com.oriplast.features.weather.presentation.WeatherFragment
import com.oriplast.mappackage.MapActivity
import com.oriplast.mappackage.MapActivityWithoutPath
import com.oriplast.mappackage.SendBrod
import com.oriplast.widgets.AppCustomEditText
import com.oriplast.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xoriplastlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.oriplast/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)

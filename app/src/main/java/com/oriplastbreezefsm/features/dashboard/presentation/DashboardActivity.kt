package com.oriplastbreezefsm.features.dashboard.presentation
...
import com.oriplastbreezefsm.app.types.TopBarConfig
import com.oriplastbreezefsm.app.uiaction.DisplayAlert
import com.oriplastbreezefsm.app.utils.*
import com.oriplastbreezefsm.app.utils.AppUtils.Companion.isProfile
...
import com.oriplastbreezefsm.features.NewQuotation.*
import com.oriplastbreezefsm.features.NewQuotation.api.GetQuotRegProvider
import com.oriplastbreezefsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.oriplastbreezefsm.features.SearchLocation.SearchLocationFragment
import com.oriplastbreezefsm.features.SearchLocation.locationInfoModel
import com.oriplastbreezefsm.features.TA.ViewAllTAListFragment
import com.oriplastbreezefsm.features.achievement.AchievementFragment
import com.oriplastbreezefsm.features.activities.presentation.*
import com.oriplastbreezefsm.features.addAttendence.*
import com.oriplastbreezefsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.oriplastbreezefsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.oriplastbreezefsm.features.addAttendence.model.GetReportToFCMResponse
import com.oriplastbreezefsm.features.addAttendence.model.GetReportToResponse
import com.oriplastbreezefsm.features.addAttendence.model.Leave_list_Response
import com.oriplastbreezefsm.features.addorder.presentation.AddOrderFragment
...
import com.oriplastbreezefsm.features.addshop.presentation.AddShopFragment
import com.oriplastbreezefsm.features.addshop.presentation.OTPVerificationDialog
import com.oriplastbreezefsm.features.addshop.presentation.ScanImageFragment
import com.oriplastbreezefsm.features.addshop.presentation.ShowCardDetailsDialog
import com.oriplastbreezefsm.features.alarm.model.AlarmData
import com.oriplastbreezefsm.features.alarm.presetation.AttendanceReportFragment
import com.oriplastbreezefsm.features.alarm.presetation.PerformanceReportFragment
import com.oriplastbreezefsm.features.alarm.presetation.VisitReportDetailsFragment
import com.oriplastbreezefsm.features.alarm.presetation.VisitReportFragment
import com.oriplastbreezefsm.features.attendance.AttendanceFragment
...
import com.oriplastbreezefsm.features.averageshop.presentation.AverageShopFragment
import com.oriplastbreezefsm.features.avgorder.presentation.AverageOrderFragment
import com.oriplastbreezefsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.oriplastbreezefsm.features.beatCustom.TeamBeatListFragment
import com.oriplastbreezefsm.features.billing.presentation.AddBillingFragment
import com.oriplastbreezefsm.features.billing.presentation.BillingDetailsFragment
import com.oriplastbreezefsm.features.billing.presentation.BillingListFragment
import com.oriplastbreezefsm.features.changepassword.presentation.ChangePasswordDialog
import com.oriplastbreezefsm.features.chat.model.ChatListDataModel
import com.oriplastbreezefsm.features.chat.model.ChatUserDataModel
import com.oriplastbreezefsm.features.chat.model.GroupUserDataModel
import com.oriplastbreezefsm.features.chat.presentation.*
import com.oriplastbreezefsm.features.chatbot.presentation.ChatBotFragment
import com.oriplastbreezefsm.features.chatbot.presentation.ChatBotShopListFragment
import com.oriplastbreezefsm.features.chatbot.presentation.ReportsFragment
import com.oriplastbreezefsm.features.chatbot.presentation.SelectLanguageDialog
import com.oriplastbreezefsm.features.commondialog.presentation.CommonDialog
import com.oriplastbreezefsm.features.commondialog.presentation.CommonDialogClickListener
import com.oriplastbreezefsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.oriplastbreezefsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.oriplastbreezefsm.features.commondialogsinglebtn.OnDialogClickListener
import com.oriplastbreezefsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.oriplastbreezefsm.features.contacts.ContactDtls
import com.oriplastbreezefsm.features.contacts.ContactGr
import com.oriplastbreezefsm.features.contacts.ContactMasterRes
import com.oriplastbreezefsm.features.contacts.ContactsAddFrag
import com.oriplastbreezefsm.features.contacts.ContactsFrag
import com.oriplastbreezefsm.features.dailyPlan.prsentation.AllShopListFragment
import com.oriplastbreezefsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.oriplastbreezefsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.oriplastbreezefsm.features.damageProduct.ShopDamageProductListFrag
import com.oriplastbreezefsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.oriplastbreezefsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.oriplastbreezefsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.oriplastbreezefsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.oriplastbreezefsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.oriplastbreezefsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.oriplastbreezefsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.oriplastbreezefsm.features.dashboard.presentation.model.ContentListResponseModel
import com.oriplastbreezefsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.oriplastbreezefsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.oriplastbreezefsm.features.device_info.presentation.DeviceInfoListFragment
import com.oriplastbreezefsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.oriplastbreezefsm.features.document.DocumentRepoFeatureNewFragment
import com.oriplastbreezefsm.features.document.presentation.DocumentListFragment
import com.oriplastbreezefsm.features.document.presentation.DocumentTypeListFragment
import com.oriplastbreezefsm.features.document.presentation.OpenFileWebViewFragment
import com.oriplastbreezefsm.features.dymanicSection.presentation.AddDynamicFragment
import com.oriplastbreezefsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.oriplastbreezefsm.features.dymanicSection.presentation.DynamicListFragment
import com.oriplastbreezefsm.features.dymanicSection.presentation.EditDynamicFragment
import com.oriplastbreezefsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.oriplastbreezefsm.features.home.presentation.HomeFragment
import com.oriplastbreezefsm.features.homelocation.presentation.HomeLocationFragment
import com.oriplastbreezefsm.features.homelocation.presentation.HomeLocationMapFragment
import com.oriplastbreezefsm.features.know_your_state.KnowYourStateFragment
import com.oriplastbreezefsm.features.lead.LeadFrag
import com.oriplastbreezefsm.features.lead.ViewLeadFrag
import com.oriplastbreezefsm.features.leaveapplynew.LeaveHome
import com.oriplastbreezefsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.oriplastbreezefsm.features.localshops.LocalShopListFragment
import com.oriplastbreezefsm.features.localshops.LocalShopListMapFragment
import com.oriplastbreezefsm.features.localshops.NearByShopsMapFragment
import com.oriplastbreezefsm.features.location.*
import com.oriplastbreezefsm.features.location.api.LocationRepoProvider
import com.oriplastbreezefsm.features.location.model.*
import com.oriplastbreezefsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.oriplastbreezefsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.oriplastbreezefsm.features.login.ShopFeedbackEntity
import com.oriplastbreezefsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.oriplastbreezefsm.features.member.model.TeamLocDataModel
import com.oriplastbreezefsm.features.member.model.TeamShopListDataModel
import com.oriplastbreezefsm.features.member.presentation.*
import com.oriplastbreezefsm.features.menuBeat.MenuBeatFrag
import com.oriplastbreezefsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.oriplastbreezefsm.features.micro_learning.presentation.MicroLearningListFragment
import com.oriplastbreezefsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.oriplastbreezefsm.features.myallowancerequest.MyallowanceRequestFragment
import com.oriplastbreezefsm.features.myjobs.model.CustomerDataModel
import com.oriplastbreezefsm.features.myjobs.presentation.*
import com.oriplastbreezefsm.features.myorder.presentation.MyOrderListFragment
import com.oriplastbreezefsm.features.myprofile.presentation.MyProfileFragment
import com.oriplastbreezefsm.features.nearbyshops.api.ShopListRepositoryProvider
...
import com.oriplastbreezefsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.oriplastbreezefsm.features.nearbyshops.presentation.BeatListFragment
import com.oriplastbreezefsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.oriplastbreezefsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.oriplastbreezefsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.oriplastbreezefsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.oriplastbreezefsm.features.newcollection.CollectionDetailsStatusFragment
import com.oriplastbreezefsm.features.newcollection.CollectionShopListFragment
import com.oriplastbreezefsm.features.newcollection.NewCollectionListFragment
import com.oriplastbreezefsm.features.newcollectionreport.*
import com.oriplastbreezefsm.features.notification.NotificationFragment
import com.oriplastbreezefsm.features.orderList.NewDateWiseOrderListFragment
import com.oriplastbreezefsm.features.orderList.NewOrderListFragment
import com.oriplastbreezefsm.features.orderList.OrderListFragment
import com.oriplastbreezefsm.features.orderdetail.presentation.OrderDetailFragment
import com.oriplastbreezefsm.features.orderhistory.ActivityMapFragment
import com.oriplastbreezefsm.features.orderhistory.OrderhistoryFragment
import com.oriplastbreezefsm.features.orderhistory.TimeLineFragment
import com.oriplastbreezefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.oriplastbreezefsm.features.orderhistory.model.FetchLocationRequest
import com.oriplastbreezefsm.features.orderhistory.model.FetchLocationResponse
import com.oriplastbreezefsm.features.orderhistory.model.LocationData
import com.oriplastbreezefsm.features.pendinglocationinout.PendingOutLocationFrag
import com.oriplastbreezefsm.features.performance.GpsStatusFragment
...
import com.oriplastbreezefsm.features.quotation.presentation.*
import com.oriplastbreezefsm.features.reimbursement.presentation.*
import com.oriplastbreezefsm.features.report.presentation.*
import com.oriplastbreezefsm.features.returnsOrder.*
import com.oriplastbreezefsm.features.settings.presentation.SettingsFragment
import com.oriplastbreezefsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.oriplastbreezefsm.features.shopdetail.presentation.*
import com.oriplastbreezefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.oriplastbreezefsm.features.stock.StockDetailsFragment
import com.oriplastbreezefsm.features.stock.StockListFragment
...
import com.oriplastbreezefsm.features.survey.SurveyFrag
import com.oriplastbreezefsm.features.survey.SurveyViewDtlsFrag
import com.oriplastbreezefsm.features.survey.SurveyViewFrag
import com.oriplastbreezefsm.features.task.presentation.AddTaskFragment
import com.oriplastbreezefsm.features.task.presentation.CalenderTaskFragment
import com.oriplastbreezefsm.features.task.presentation.EditTaskFragment
import com.oriplastbreezefsm.features.task.presentation.TaskListFragment
import com.oriplastbreezefsm.features.taskManagement.TaskManagementFrag
import com.oriplastbreezefsm.features.taskManagement.ViewTaskManagementFrag
import com.oriplastbreezefsm.features.timesheet.presentation.AddTimeSheetFragment
import com.oriplastbreezefsm.features.timesheet.presentation.EditTimeSheetFragment
import com.oriplastbreezefsm.features.timesheet.presentation.TimeSheetListFragment
import com.oriplastbreezefsm.features.viewAllOrder.CartFragment
import com.oriplastbreezefsm.features.viewAllOrder.OrderTypeListFragment
import com.oriplastbreezefsm.features.viewAllOrder.ViewAllOrderListFragment
import com.oriplastbreezefsm.features.viewAllOrder.ViewCartFragment
import com.oriplastbreezefsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.oriplastbreezefsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.oriplastbreezefsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.oriplastbreezefsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.oriplastbreezefsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.oriplastbreezefsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.oriplastbreezefsm.features.viewPPDDStock.ViewOutstandingFragment
import com.oriplastbreezefsm.features.viewPPDDStock.ViewPPDDListFragment
import com.oriplastbreezefsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.oriplastbreezefsm.features.viewPPDDStock.ViewStockFragment
import com.oriplastbreezefsm.features.weather.presentation.WeatherFragment
import com.oriplastbreezefsm.mappackage.MapActivity
import com.oriplastbreezefsm.mappackage.MapActivityWithoutPath
import com.oriplastbreezefsm.mappackage.SendBrod
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xoriplastbreezefsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastbreezefsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.oriplastbreezefsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastbreezefsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastbreezefsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastbreezefsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoriplastbreezefsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)

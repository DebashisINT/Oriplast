package com.oriplastbreezefsm.features.location
...
import com.oriplastbreezefsm.MonitorBroadcast
import com.oriplastbreezefsm.R
import com.oriplastbreezefsm.app.*
import com.oriplastbreezefsm.app.Pref.tempDistance
...
import com.oriplastbreezefsm.app.utils.AppUtils.Companion.getDateTimeFromTimeStamp
import com.oriplastbreezefsm.app.utils.AppUtils.Companion.isLocationActivityUpdating
...
import com.oriplastbreezefsm.base.presentation.BaseActivity.Companion.isMeetingUpdating
import com.oriplastbreezefsm.base.presentation.BaseActivity.Companion.isShopActivityUpdating
...
import com.oriplastbreezefsm.features.dashboard.presentation.SystemEventReceiver
...
import com.oriplastbreezefsm.features.gpsstatus.GpsReceiver
import com.oriplastbreezefsm.features.gpsstatus.LocationCallBack
import com.oriplastbreezefsm.features.location.LocationWizard.Companion.NEARBY_RADIUS
import com.oriplastbreezefsm.features.location.api.LocationRepoProvider
import com.oriplastbreezefsm.features.location.ideallocapi.IdealLocationRepoProvider
       ...
       // mantis 25637
        ...
        try{
            ...
            if (locList != null && locList.isNotEmpty()) {
                ...
                if(diffInMin<3 && location.distance.toDouble().toInt()>5){

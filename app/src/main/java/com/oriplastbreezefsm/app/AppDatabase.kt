...
import com.oriplastbreezefsm.app.AppConstant.DBNAME
import com.oriplastbreezefsm.app.domain.*
import com.oriplastbreezefsm.features.lead.model.LeadActivityDao
import com.oriplastbreezefsm.features.lead.model.LeadActivityEntity
import com.oriplastbreezefsm.features.location.UserLocationDataDao
import com.oriplastbreezefsm.features.location.UserLocationDataEntity
import com.oriplastbreezefsm.features.login.*
import com.oriplastbreezefsm.features.taskManagement.model.TaskManagementDao
...
//                        "date TEXT, time TEXT,isWhatsappSent INTEGER NOT NULL DEFAULT 0,whatsappSentMsg TEXT,transactionId TEXT,isUploaded INTEGER NOT NULL DEFAULT 0,transactionId TEXT NOT NULL DEFAULT '')")
        ...
        val Migration_4_5: Migration = object :Migration(4,5){
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL("ALTER TABLE shop_deta" +
                        "il ADD COLUMN companyName TEXT")
